...
-- 
-- Host: localhost:3306
-- Generato il: 27 Mar, 2007 at 10:52 AM
...
INSERT INTO `country` (`id`, `Code`, `Name`, `Continent`, `SurfaceArea`, `Population`, `LocalName`) VALUES 
(1, 'AFG', 'Afghanistan5', 'South America', 652090.00, 2272, 'Afganoistan'),
(2, 'NLD', 'Netherlands', 'Asia', 41526.00, 158640, 'Nede'),
...
(240, 'ZZZ', 'zzzzz', 'South America', 0.00, 0, ''),
(241, 'zzz', 'zzzzz', 'South America', 88.00, 99, 'uffa');
...
(6, 'William', 'Brown', 2300, 21, '2001-03-10', 3, 1, 10, '6.jpg'),
(7, 'Lucca', 'Normany', 2800, 36, '2006-10-02', 3, 0, 20, '7.jpg');

-- --------------------------------------------------------

-- 
-- Struttura della tabella `inlinemod`
-- 
...
CREATE TABLE `inlinemod` (
  ...
  `nota` varchar(255) collate latin1_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=3 ;

-- 
-- Dump dei dati per la tabella `inlinemod`
-- 

INSERT INTO `inlinemod` (`id`, `nom`, `prenom`, `adresse`, `code_postal`, `ville`, `enfants`, `email`, `nota`) VALUES 
(1, 'Martel', 'Myriam', '14 rue Rebeval', '75019', 'Paris', 2, 'lulumartl@email.it', 'uuffr'),
(2, 'Dupond', 'Albert', '2 Boulevard Morland', '75004', 'Paris', 0, 'albert.dupond@email.fr', '');
...
INSERT INTO `person` (`id`, `lastname`, `firstname`, `email`, `origin`) VALUES 
(7, 'xcvbxcb', '', 'BBC', '1'),
(2, 'Vazquez', 'Vianney', 'vianney.vazquez@gmail.com', '1'),
(3, 'Velazquez', 'Paulina', 'paulina.velazquez@gmail.cmo', '1'),
(4, 'Velazquez', 'Mariana', 'mariana.velazquez@gmail.com', '0'),
(5, 'Contreras', 'Carlos', 'ccontrer@cybercable.net.mx', '0'),
(8, 'fgjsfgjfgsj', '', 'hgfjgfj', '1'),
(9, '66666', '', '66666', '0'),
(10, 'nxnxnx', '', 'ncvncncvncvncznzcnvnv', '0');
...
INSERT INTO `tblusers` (`UserId`, `Name`, `Email`, `DOB`, `ru_fp`) VALUES 
(9, 'Neeraj', 'neeraj@yahool.com', '1980-04-04', 0),
(10, 'tqtet', 'tqewtewqt', '1980-04-04', 0),
(11, 'uffa', 'fsafasf', '1979-05-01', 0),
(13, 'cazzo', 'figa', '1980-04-04', 0),
(14, 'yyyffff', 'fffffff@bfbf.com', '1979-01-01', 0),
(15, '1980-04-04', '1980-04-04', '1980-04-04', 0),
(19, 'ewqet', 'weqtewqt', '0', 1),
(20, 'weqtewqt', 'ewqt', '1', 1),
(21, 'wqtet', 'etew', 'twqt', 1),
(22, 'wqtewt', 'ewtewtwe', 'ttwqtqewt', 1),
(23, 'wqetewtee', 'wetet', '1', 1),
(24, '12341325', '3215325', '1', 1);
